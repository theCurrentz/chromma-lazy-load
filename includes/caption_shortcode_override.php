...
function chroma_img_caption_shortcode( $empty, $attr, $content ) {
  ...
  $new_content = '<figure class="entry-content_figure fig-wcaption" data-dims="'.$height.$width.'" style="padding-bottom:'.$aspectRatio.'%">'.$image.'<figcaption class="figcaption">'.$new_caption.'</figcaption></figure>';
	return $new_content;
}
